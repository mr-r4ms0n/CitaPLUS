 ...
 * @author Kevin
 */
public class Confirm extends java.awt.Dialog
{
    ...
    private void initComponents()
    {
        ...
        btnCancelar.setBackground(new java.awt.Color(227, 113, 113));
        btnCancelar.setText("No");
        btnCancelar.setBackgroundHover(new java.awt.Color(214, 156, 156));
        btnCancelar.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        btnCancelar.setIcons(rojeru_san.efectos.ValoresEnum.ICONS.CHECK_CIRCLE);
    ...
    public static void main(String args[])
    {
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                Confirm dialog = new Confirm(new java.awt.Frame(), true);
    ...
    private newscomponents.RSButtonIcon_new btnCancelar;
